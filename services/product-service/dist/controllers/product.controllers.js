...
export class ProductController {
    ...
    async createProduct(req, res, next) {
        try {
            ...
            const newProduct = await productService.createProduct(categoryId, versionData, detailsData, Number(initialStock));
    ...
    async createNewVersion(req, res, next) {
        try {
            ...
            const newVersion = await productService.createNewVersion(productId, updateData, detailsData, Number(initialStock));
    ...
    //ADMIN LIST
    async getAllProductsForAdmin(req, res, next) {
        try {
    ...
    async getProductVersion(req, res, next) {
        try {
