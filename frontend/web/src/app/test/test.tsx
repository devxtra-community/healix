...
export default function HealixPage() {
 ...
 {categories.map((cat, idx) => (
              ...
              <div key={idx} className="flex items-center space-x-2 px-6 border-r last:border-r-0 border-gray-200 whitespace-nowrap">
                {cat.icon}
      ...
      <section className="max-w-4xl mx-auto text-center py-20 px-6">
        <h1 className="text-3xl md:text-4xl leading-snug font-medium mb-10">
          At <span className="text-[#5D9F3C] font-bold">Healix,</span> we are passionate about <br />delivering clean, nutrient-dense products <br />
           that support a <span className="text-[#5D9F3C]">healthier</span> lifestyle. Rooted in <br />the 
          <span className="text-[#5D9F3C]">science of wellness,</span> our store sources <br /> <span className="text-[#5D9F3C]">high-quality</span> ingredients and 
          <span className="text-[#5D9F3C] ">follows <br />
          sustainable, transparent practices</span> to <br /> protect your health. 
        </h1>
      ...
      <section className="">
        <h2 className="text-center text-xl font-medium ">Your Daily Essential for Better Health</h2>
...
/>
        ...
        <div className="text-center px-6 mb-10">
          <p className="text-gray-600 text-sm max-w-md mx-auto mb-8">
            Explore our full range of targeted nutrition products designed to help you feel and perform your best every day.
          </p>
