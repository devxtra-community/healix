...
export default function Personalization() {
  return (
    <section className="py-20 px-6 max-w-4xl mx-auto text-center">
      <h2 className="text-4xl font-semibold mb-6">Why Personalization Matters</h2>
      <p className="text-xl text-gray-700 leading-relaxed mb-12">
        Your body is unique. your nutrition should be too. Our personalized approach ensures 
        you get the right ingredients, in the right amounts, made specifically for your goals and lifestyle.
      </p>
