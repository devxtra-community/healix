...
const Navbar = () => (
  <nav className="flex items-center justify-between py-6 px-6 max-w-[1400px] mx-auto w-full">
    ...
    <div className="flex items-center gap-2">
      ...
      <span className="text-2xl font-bold text-gray-900 tracking-tight">Healix</span>
    </div>
    ...
    <div className="hidden md:flex items-center gap-10 text-xl font-medium text-gray-800">
      ...
      <a href="#" className="hover:text-green-600 transition">Health Goals</a>
    ...
    <div className="flex items-center  gap-6">
      <button className="text-gray-900 hover:text-green-600"><User className="w-7 h-7" /></button>
      <button className="text-gray-900 hover:text-green-600"><Heart className="w-7 h-7" /></button>
      <button className="text-gray-900 hover:text-green-600"><ShoppingBag className="w-7 h-7" /></button>
    </div>
  </nav>
);
...
const HeroText = () => (
  <section className="text-center px-4 mt-12 mb-16 max-w-4xl mx-auto">
    ...
    <p className="text-gray-500 text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
      Clean, targeted formulas that fuel your gut,<br className="hidden md:block" />
...
const ProductCard = ({ 
  ...
  <div className={`${heightClass} ${shapeClass} ${bgColor} w-full relative group overflow-hidden transition-transform hover:scale-[1.02] duration-500`}>
