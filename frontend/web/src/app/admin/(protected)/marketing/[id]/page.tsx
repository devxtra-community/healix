...
import CampaignForm from '@/src/components/admin/marketing/CampaignForm';
...
export default function EditCampaignPage() {
  ...
  const mockData = {
    ...
    endDate: '2024-08-31',
    targetAudience:
      'Adults aged 25-45 interested in outdoor activities and summer fashion.',
  };
  ...
  return (
    <div className="flex flex-col gap-6 pt-2 pb-8">
      ...
      <CampaignForm initialData={mockData} />
    </div>
  );
}
