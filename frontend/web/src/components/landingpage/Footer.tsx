    ...
    <footer className="bg-[#5D9F3C] text-white py-10 md:py-16 px-6 md:px-10">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
        ...
        <div className="col-span-2 md:col-span-1">
          <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">HEALIX STORY</h2>
        ...
        {/* Quick Links */}
        <div>
          <h3 className="font-bold mb-4 md:mb-6 text-base md:text-xl">Quick Links</h3>
        ...
        {/* Customer Support */}
        <div>
          <h3 className="font-bold mb-4 md:mb-6 text-base md:text-xl">Customer support</h3>
          <ul className="space-y-2 md:space-y-3 opacity-90 text-sm md:text-base">
        ...
        {/* Contact */}
        <div>
          <h3 className="font-bold mb-4 md:mb-6 text-base md:text-xl">Contact</h3>
          <ul className="space-y-2 md:space-y-3 opacity-90 text-sm md:text-base">
            <li>+91-7458946131</li>
